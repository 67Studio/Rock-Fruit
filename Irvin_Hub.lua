-- fuhed at <<https://dsc.gg/glassluau>>

getfenv()
--[[ getfenv() reads: error (x19), game (x5), loadstring, math (x33), pairs (x2), pcall (x49), setmetatable, string (x303), table (x280), tonumber (x17), tostring (x47) ]]
game:GetService("Players")
game:GetService("TweenService")
game:GetService("TextChatService")
game:GetService("RunService")
local _ = game:GetService("Players").LocalPlayer
game:HttpGet("https://pastefy.app/hiqKYJrz/raw")

game:HttpGet("https://pastebin.com/raw/XqZsnzRQ", true)
...
screenGui.Name = "redz Library V5"
game:GetService("CoreGui"):FindFirstChild("redz Library V5")

game:GetService("Workspace").FallenPartsDestroyHeight = -math.huge

Instance.new("ImageButton")
local imageButton = Instance.new("ImageButton")
imageButton.Parent = redz Library V5
imageButton.Name = "Hub"
Hub.Position = UDim2.new(0.5, -275, 0.5, -190)

local _ = game:GetService("Players").LocalPlayer.Name
game:GetService("Players"):FindFirstChild("COMANF667")
game:GetService("Players"):FindFirstChild("kaynahhhhh")
game:GetService("Players"):FindFirstChild("incomun192988")
game:GetService("Players"):FindFirstChild("beqyan1358")
game:GetService("Players"):FindFirstChild("olliver2045judoca")
game:GetService("Players"):FindFirstChild("igky81")
game:GetService("Players").PlayerAdded:Connect(function() end --[[ callback ]])
local _ = game:GetService("TextChatService").TextChannels.GetChildren
game:GetService("TextChatService"):GetChildren()
game:GetService("TextChatService").BubbleChatConfiguration:IsA("TextChannel")
game:GetService("TextChatService").ChannelTabsConfiguration:IsA("TextChannel")
game:GetService("TextChatService").ChatInputBarConfiguration:IsA("TextChannel")
game:GetService("TextChatService").ChatWindowConfiguration:IsA("TextChannel")
game:GetService("TextChatService").TextChannels.ChildAdded:Connect(function() end --[[ callback ]])
...
InfoTab:AddParagraph({ "You Language:", "Português" })

InfoTab:AddParagraph({ "You are Playing:", "Brookhaven RP 🏡" })

InfoTab:AddParagraph({ "You are Using:", "Irvin Hub" })
